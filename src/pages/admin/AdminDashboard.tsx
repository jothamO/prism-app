...
export default function AdminDashboard() {
  const metrics = [
    { title: "Total Users", value: "3,247", change: "+12%", icon: Users, color: "text-blue-400", bg: "bg-blue-400/10" },
    { title: "Monthly Revenue", value: "₦6.5M", change: "+18%", icon: DollarSign, color: "text-green-400", bg: "bg-green-400/10" },
    { title: "Filings This Month", value: "2,890", change: "89% Auto", icon: FileText, color: "text-purple-400", bg: "bg-purple-400/10" },
    { title: "Review Queue", value: "47", change: "8 High Priority", icon: ShieldAlert, color: "text-orange-400", bg: "bg-orange-400/10" }
  ];
