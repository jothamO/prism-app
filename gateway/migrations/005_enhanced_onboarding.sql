...
-- Add business stage tracking
ALTER TABLE public.businesses 
ADD COLUMN IF NOT EXISTS business_stage VARCHAR(20) CHECK (business_stage IN ('pre_revenue', 'early', 'growing', 'established')),
...
-- Comments
COMMENT ON COLUMN businesses.business_stage IS 'Current business maturity: pre_revenue, early, growing, established';
