...
class TaxService {
    ...
    async calculateWHT(params: WHTParams, userId?: string): Promise<WHTResult> {
        return this.callTaxCalculate<WHTResult>('wht', params as unknown as Record<string, unknown>, userId);
    }
    ...
    async calculateCGT(params: CGTParams, userId?: string): Promise<CGTResult> {
        return this.callTaxCalculate<CGTResult>('cgt', params as unknown as Record<string, unknown>, userId);
    }
    ...
    async calculateCIT(params: CITParams, userId?: string): Promise<CITResult> {
        return this.callTaxCalculate<CITResult>('cit', params as unknown as Record<string, unknown>, userId);
    }
    ...
    async calculateVAT(params: VATParams, userId?: string): Promise<VATResult> {
        return this.callTaxCalculate<VATResult>('vat', params as unknown as Record<string, unknown>, userId);
    }
    ...
    async calculateStampDuty(params: StampDutyParams, userId?: string): Promise<StampDutyResult> {
        return this.callTaxCalculate<StampDutyResult>('stamp', params as unknown as Record<string, unknown>, userId);
    }
    ...
    async calculateMETR(params: METRParams, userId?: string): Promise<METRResult> {
        return this.callTaxCalculate<METRResult>('metr', params as unknown as Record<string, unknown>, userId);
    }
}
