...
**User says**:
```
"Hey Prism, show me what I spent on the house project last week"
```
...
**User says**:
```
"How much can I save on rent relief?"
```
...
- Sections: Personal Reliefs, Business Reliefs
...
**User says**:
```
"Tag my new TV as a business expense"
```
...
Claiming "TV" as "business expense" may be viewed as
an artificial transaction by FIRS.
        ...
        sections: [
            {
                ...
                rows: [
                    { 
                        id: 'relief_rent', 
                        title: 'Rent Relief (20%)', 
                        description: 'Max ₦500K/year' 
                    },
                    { 
                        id: 'relief_pension', 
                        title: 'Pension (8%)', 
            ...
            },
            {
                ...
                rows: [
                    { 
                        id: 'relief_small_biz', 
                        title: 'Small Business 0%', 
                        description: 'Revenue < ₦50M' 
                    }
                ]
            }
        ]
    ...
    if (buttonResponse) {
        ...
        if (response.useInteractiveButtons) {
            ...
            if (buttonConfig.type === 'reply') {
                await whatsappInteractiveService.sendReplyButtons(
                    buttonResponse.userId,
                    response.message || 'Select an option:',
